...
> Daily maintenance: keeping GitHub updated with incremental improvements. (2026-08-13)
...
> **Security Notice (2026-08-10):** Kilo Code / Anaconda notified users of a Metabase BI security incident on 2026-08-06. If you use Kilo Code with shared credentials, review your session history, audit API tokens, rotate any reused passwords, and monitor for phishing. See the [Anaconda blog](https://www.anaconda.com/blog) for updates.
